...
|------|------|-------|----------|---------|
| .claude/skills/repo-xray/lib/__init__.py | 0.44 | 1 | 0 | 1 |
| .claude/skills/repo-xray/lib/ast_utils.py | 0.44 | 1 | 0 | 1 |
| .claude/skills/repo-xray/lib/token_estimator.py | 0.44 | 1 | 0 | 1 |
| .claude/skills/repo-xray/scripts/configure.py | 0.44 | 1 | 0 | 1 |
| .claude/skills/repo-xray/scripts/dependency_graph.py | 0.44 | 1 | 0 | 1 |
| .claude/skills/repo-xray/scripts/mapper.py | 0.44 | 1 | 0 | 1 |
| .claude/skills/repo-xray/scripts/skeleton.py | 0.44 | 1 | 0 | 1 |
...
|----------|------------|-------------|
| Active | 7 | Changed in last 30 days |
