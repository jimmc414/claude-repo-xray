...
The scanner extracts 37+ signals from the AST, import graph, git history, and code patterns. It doesn't interpret these signals — it just surfaces them. Interpretation is the agent's job.
