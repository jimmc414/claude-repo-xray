...
> Compare with `WARM_START.example.md` which shows a Claude-enhanced version.

> Context-efficient onboarding guide for AI programmers.
> Generated: 2025-12-12
> Token budget: ~101K tokens
...
| Tokens | File | Note |
|--------|------|------|
| 10.4K | `planning/Phase2_Implementation_plan.md` | Consider skeleton |
