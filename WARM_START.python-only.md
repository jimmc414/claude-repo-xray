...
> **Python tool output** - generated by `generate_warm_start.py` without human review.
> Compare with `WARM_START.enhanced.md` for a Claude-reviewed version with additional context.
