...
Generated: 2025-12-15T06:42:26.252318Z | Preset: None | Files: 793
...
| Variable | File | Line |
|----------|------|------|
| `ANTHROPIC_API_KEY` | anthropic.py | 87 |
...
| `LLM_PROVIDER` | config.py | 215 |
| `MP_API_KEY` | phase_diagram_generator.py | 39 |
| `NEO4J_URI` | conftest.py | 434 |
| `OPENAI_API_KEY` | config.py | 217 |
| `OPENAI_BASE_URL` | test_provider_switching.py | 114 |
| `OPENAI_MODEL` | test_provider_switching.py | 121 |
| `OPENAI_ORGANIZATION` | openai.py | 117 |
| `OPENROUTER_API_KEY` | examples.py | 135 |
...
*Generated by Repo X-Ray v3.0.0*